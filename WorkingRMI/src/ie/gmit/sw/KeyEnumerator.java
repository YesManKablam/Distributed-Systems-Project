...
public class KeyEnumerator {
	...
	public static void main(String[] args) throws Exception {
		new KeyEnumerator().crackCypher("CHZFXNLYOULRTPIJNVLNBINIHLOICTANZDLRTCTWNSOUSHOACNYHZRHQAQICPANIIBOWJTLTDVTCHZISNNOIURCVTXXNJFLNAFNTBSZSLRTCICJCMYECOBRPYHDCHHSOEB", 5);
	}
}